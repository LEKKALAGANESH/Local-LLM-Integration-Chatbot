...
async def chat(request: Request):
    ...
    if is_ingredients_query(query):
        ...
        try:
            ...
            recipe_text = f"Try a simple {best_recipe['cuisine']} dish using your ingredients: {user_ingredients}. Suggested ingredients from match: {ingredients_list}. Basic idea: Cook the ingredients together with spices for a quick meal."
